...
| **Rust LOC** | 8,400+ |
| **Rust tests** | 477 (up from 305 after B-1, B-2, B-3, B-5 regressions and the A-1 follow-up enrollment-challenge plumbing; macOS dev host) |
...
| **Python tests** | 13 |
| **Total tests** | 732 ✅ all passing on the macOS dev host (Rust + macOS .NET + Python). Windows-side .NET / native counts are CI-verified (last run 2026-04-24). |

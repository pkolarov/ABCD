...
fn test_subcommand_help() {
    ...
    for tree in [
        ...
        vec!["platform", "windows", "software", "--help"],
        vec!["platform", "windows", "applied", "--help"],
        vec!["platform", "windows", "claim-account", "--help"],
        vec!["platform", "macos", "--help"],
        vec!["platform", "macos", "policies", "--help"],
        vec!["platform", "macos", "software", "--help"],
        vec!["platform", "macos", "applied", "--help"],
        vec!["platform", "linux", "--help"],
        vec!["platform", "linux", "policies", "--help"],
        vec!["platform", "linux", "software", "--help"],
        vec!["platform", "linux", "applied", "--help"],
        vec!["debug", "--help"],
        vec!["debug", "ping", "--help"],
        vec!["debug", "stats", "--help"],
        vec!["debug", "config", "--help"],
        vec!["debug", "node-info", "--help"],
        vec!["stats", "--help"],
        vec!["health", "--help"],
...
fn test_remote_commands_fail_when_node_absent() {
    ...
    for tree in [
        ...
        vec!["--node-url", bad_url, "debug", "node-info"],

...
We have over 700 tests in the Rust workspace (796 / 796 passing as of 2026-05-24 — `cargo test --workspace --lib`, 5 ignored). Tests are the absolute best documentation for seeing how the pieces are expected to behave when pushed to their limits.
